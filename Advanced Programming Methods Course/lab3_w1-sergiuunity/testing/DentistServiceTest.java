...
public class DentistServiceTest {
    ...
    void testAll()
    {
        ...
        //tests
        assertEquals(dentist, dentistService.getDentist());

        dentistService.setDentist(dentist);

        assertEquals(dentist, dentistService.getDentist());

        dentistService.modifyDentistDetails("new name");

        assertEquals("new name", dentistService.getDentist().getName());
