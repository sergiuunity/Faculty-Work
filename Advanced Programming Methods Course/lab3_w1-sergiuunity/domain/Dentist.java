...
public class Dentist implements Entity<String> {
    ...
    {
        System.out.println("Dentist:" + "id=" + id + ", name=" + name + '\n');
        Consumer<PatientsRepo> consumer = PatientsRepo::printPatients;
        consumer.accept(this.getPatients());
        System.out.println("\n");
        Consumer<AppointmentsRepo> consumer2 = AppointmentsRepo::printAppointments;
        consumer2.accept(this.getAppointments());
